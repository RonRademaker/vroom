...
Vehicle::Vehicle(Id id,
  ...
  : id(id),
    ...
    max_daily_travel_time(max_daily_travel_time.has_value()
                            ? utils::scale_from_user_duration(max_daily_travel_time.value())
                            : DEFAULT_MAX_TRAVEL_TIME),
...
bool Vehicle::has_range_bounds() const {
  return max_travel_time != DEFAULT_MAX_TRAVEL_TIME ||
         max_daily_travel_time != DEFAULT_MAX_TRAVEL_TIME ||
